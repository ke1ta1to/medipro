...
public class WorldLoader {
        ...
        public static World loadWorld(StageModel model, String baseDir) {
                ...
                InputStream metadataText = classLoader
                                .getResourceAsStream(
                                                "net/keitaito/medipro/world_templates/" + baseDir + "/metadata.json");

                World world = model.loadWorld(worldTxt, exampleInputTxt, thumbnailUrl, metadataText);
                return world;
        }
